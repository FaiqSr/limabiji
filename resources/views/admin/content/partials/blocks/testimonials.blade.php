<div class="space-y-3">
    ...
    <div class="p-3 bg-indigo-50 border border-indigo-100 rounded-lg text-xs text-indigo-700 space-y-1">
        <p class="font-bold flex items-center gap-1">
            ...
            <span>Testimonials (Database)</span>
        </p>
        <p class="text-[11px] text-indigo-600 leading-relaxed">
            Daftar testimoni pelanggan diambil secara otomatis dari Database. Anda dapat mengelola testimoni di menu 
            <a href="{{ route('admin.testimonials.index') }}" target="_blank" class="font-bold underline text-indigo-800 hover:text-indigo-900">Admin > Testimonials</a>.
        </p>
    </div>
</div>
