...
@section('content')
<form action="{{ route('admin.innovation-steps.update', $innovationStep) }}" method="POST" x-data="{ locale: 'en' }" class="max-w-4xl mx-auto space-y-6">
    @csrf
    @method('PUT')
