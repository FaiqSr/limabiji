    ...
    <script>
        (function() {
            ...
            inView("[data-animate='fade-up']", (element) => {
                animate(element,
                    { opacity: [0, 1], y: [48, 0] },
                    { duration: 0.7, easing: [0.25, 0.46, 0.45, 0.94], delay: element.dataset.delay ? parseFloat(element.dataset.delay) : 0 }
                );
                return () => animate(element, { opacity: 0, y: 48 }, { duration: 0.3 });
            });
            ...
            inView("[data-animate='fade-in']", (element) => {
                animate(element,
                    { opacity: [0, 1] },
                    { duration: 0.8, easing: "ease-out", delay: element.dataset.delay ? parseFloat(element.dataset.delay) : 0 }
                );
                return () => animate(element, { opacity: 0 }, { duration: 0.3 });
            });
            ...
            inView("[data-animate='stagger']", (element) => {
                ...
                return () => animate(items, { opacity: 0, y: 32 }, { duration: 0.2, delay: stagger(0) });
            });
            ...
            inView("[data-animate='scale-in']", (element) => {
                animate(element,
                    ...
                    { duration: 0.6, easing: [0.25, 0.46, 0.45, 0.94], delay: element.dataset.delay ? parseFloat(element.dataset.delay) : 0 }
                );
                return () => animate(element, { opacity: 0, scale: 0.92 }, { duration: 0.2 });
            });
        })();
    </script>
