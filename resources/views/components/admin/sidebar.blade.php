...
<aside :class="mobileOpen ? 'translate-x-0' : '-translate-x-full lg:translate-x-0'"
    ...
    <nav class="flex-1 px-3 py-4 space-y-1 overflow-y-auto">
        ...
        <!-- Agritech & Supply -->
        <div class="pt-4 pb-1">
            <div class="px-3 text-[10px] font-bold text-slate-400 uppercase tracking-wider font-mono">Agritech & Export</div>
        </div>
        ...
        <x-admin.nav-link href="{{ route('admin.innovation-steps.index') }}" :active="request()->routeIs('admin.innovation-steps.*')">
            ...
            <span class="flex-1">Process Steps</span>
        </x-admin.nav-link>

        <!-- Content & Stories -->
        <div class="pt-4 pb-1">
            <div class="px-3 text-[10px] font-bold text-slate-400 uppercase tracking-wider font-mono">Content & Stories</div>
        </div>
        ...
        <x-admin.nav-link href="{{ route('admin.certificates.index') }}" :active="request()->routeIs('admin.certificates.*')">
            ...
            <span class="flex-1">Certificates</span>
        </x-admin.nav-link>
        ...
        <div class="pt-4 pb-1">
            <div class="px-3 text-[10px] font-bold text-slate-400 uppercase tracking-wider font-mono">Inquiries & Media</div>
        </div>
        ...
        <x-admin.nav-link href="{{ route('admin.messages.index') }}" :active="request()->routeIs('admin.messages.*')">
            ...
            @if ($unreadMessagesCount > 0)
                <span class="bg-indigo-50 text-indigo-700 text-xs font-semibold px-2 py-0.5 rounded-lg border border-indigo-200">{{ $unreadMessagesCount }}</span>
            @endif
        </x-admin.nav-link>
        ...
        <div class="pt-4 pb-1">
            <div class="px-3 text-[10px] font-bold text-slate-400 uppercase tracking-wider font-mono">System</div>
        </div>
