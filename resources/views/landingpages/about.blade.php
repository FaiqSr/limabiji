...
<div class="container mx-auto px-5 pt-10 pb-10 lg:pt-5 lg:pb-5">
    <div class="max-w-5xl">
        ...
        <div data-animate="fade-up" data-delay="0.3" class="flex sm:flex-row flex-col items-start gap-4 mt-10">
            ...
            <x-btn-outline :href="url('/contact')" :label="__('landing.cta_secondary')" />
        </div>
    </div>
</div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
        ...
        <div class="lg:col-span-7 space-y-6">
            <div>
                ...
                <h2 class="font-display text-4xl sm:text-5xl text-dark leading-tight uppercase">
            ...
            <p class="text-dark/80 text-base leading-relaxed font-medium">
                {{ __('landing.about_story_p2') }}
            </p>
            <p class="text-light-grey text-base leading-relaxed">
                {{ __('landing.about_story_p3') }}
            </p>
        </div>
        ...
        <div class="lg:col-span-5 relative">
            <div class="rounded-2xl overflow-hidden h-[420px] bg-surface-alt border border-border relative group shadow-xl">
                ...
                <div class="absolute bottom-6 left-6 right-6 flex items-center justify-between gap-4">
                    <div class="bg-surface/90 backdrop-blur-xs p-3 rounded-xl border border-border text-xs">
                        <p class="text-dark/50 text-[10px] uppercase font-bold tracking-wider">Quality Benchmark</p>
                        <p class="font-display text-2xl text-dark">84+ SCA</p>
                    </div>
                    <div class="bg-primary text-dark p-3 rounded-xl font-bold text-xs shadow-md">
                        100% Cruelty-Free
                    </div>
                </div>
            </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <div data-animate="fade-up" class="card-solid p-8 sm:p-12 flex flex-col justify-between">
            <div>
                ...
                <h3 class="font-display text-3xl sm:text-4xl text-dark uppercase mb-4">{{ __('landing.about_vision_title') }}</h3>
                <p class="text-light-grey text-base leading-relaxed">
                    {{ __('landing.about_vision_desc') }}
                </p>
            </div>
            <div class="mt-8 pt-6 border-t border-border/50 text-xs font-mono uppercase text-dark/40">
        ...
        <div data-animate="fade-up" data-delay="0.1" class="card-solid p-8 sm:p-12 flex flex-col justify-between">
            <div>
                ...
                <h3 class="font-display text-3xl sm:text-4xl text-dark uppercase mb-6">{{ __('landing.about_mission_title') }}</h3>
                <ul class="space-y-4">
                    <li class="flex items-start gap-3 text-dark/80 text-sm leading-relaxed">
                        <span class="w-5 h-5 rounded-full bg-primary/20 text-primary flex items-center justify-center shrink-0 mt-0.5">✓</span>
                        <span>{{ __('landing.about_mission_1') }}</span>
                    </li>
                    <li class="flex items-start gap-3 text-dark/80 text-sm leading-relaxed">
                        <span class="w-5 h-5 rounded-full bg-primary/20 text-primary flex items-center justify-center shrink-0 mt-0.5">✓</span>
                        <span>{{ __('landing.about_mission_2') }}</span>
                    </li>
                    <li class="flex items-start gap-3 text-dark/80 text-sm leading-relaxed">
                        <span class="w-5 h-5 rounded-full bg-primary/20 text-primary flex items-center justify-center shrink-0 mt-0.5">✓</span>
                        <span>{{ __('landing.about_mission_3') }}</span>
                    </li>
                    <li class="flex items-start gap-3 text-dark/80 text-sm leading-relaxed">
                        <span class="w-5 h-5 rounded-full bg-primary/20 text-primary flex items-center justify-center shrink-0 mt-0.5">✓</span>
                        <span>{{ __('landing.about_mission_4') }}</span>
                    </li>
                </ul>
            </div>
            <div class="mt-8 pt-6 border-t border-border/50 text-xs font-mono uppercase text-dark/40">
...
<div class="container mx-auto px-5 py-24">
    <div class="text-center max-w-3xl mx-auto mb-16">
        ...
        <h2 data-animate="fade-up" data-delay="0.1" class="font-display text-4xl sm:text-5xl text-dark uppercase mb-4">
    ...
    <div data-animate="stagger" class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <div class="stagger-item card-solid p-8 rounded-2xl border border-border hover:border-primary/40 transition-all duration-300">
            ...
            <h4 class="font-display text-2xl text-dark uppercase mb-2">{{ __('landing.about_val_1_title') }}</h4>
        ...
        <div class="stagger-item card-solid p-8 rounded-2xl border border-border hover:border-primary/40 transition-all duration-300">
            ...
            <h4 class="font-display text-2xl text-dark uppercase mb-2">{{ __('landing.about_val_2_title') }}</h4>
        ...
        <div class="stagger-item card-solid p-8 rounded-2xl border border-border hover:border-primary/40 transition-all duration-300">
            ...
            <h4 class="font-display text-2xl text-dark uppercase mb-2">{{ __('landing.about_val_3_title') }}</h4>
        ...
        <div class="stagger-item card-solid p-8 rounded-2xl border border-border hover:border-primary/40 transition-all duration-300">
            ...
            <h4 class="font-display text-2xl text-dark uppercase mb-2">{{ __('landing.about_val_4_title') }}</h4>
...
<div class="container mx-auto px-5 py-24">
    ...
    <div data-animate="fade-up" class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <div class="card-solid p-6 rounded-2xl relative border-t-4 border-t-primary">
            ...
            <h4 class="font-display text-2xl text-dark uppercase mb-2">{{ __('landing.about_time_1_title') }}</h4>
            <p class="text-light-grey text-sm leading-relaxed">{{ __('landing.about_time_1_desc') }}</p>
        </div>

        {{-- Milestone 2 --}}
        <div class="card-solid p-6 rounded-2xl relative border-t-4 border-t-primary">
            <span class="text-xs font-mono font-semibold text-primary block mb-2">{{ __('landing.about_time_2_period') }}</span>
            <h4 class="font-display text-2xl text-dark uppercase mb-2">{{ __('landing.about_time_2_title') }}</h4>
        ...
        <div class="card-solid p-6 rounded-2xl relative border-t-4 border-t-primary">
            ...
            <h4 class="font-display text-2xl text-dark uppercase mb-2">{{ __('landing.about_time_3_title') }}</h4>
            <p class="text-light-grey text-sm leading-relaxed">{{ __('landing.about_time_3_desc') }}</p>
        </div>

        {{-- Milestone 4 --}}
        <div class="card-solid p-6 rounded-2xl relative border-t-4 border-t-primary">
            <span class="text-xs font-mono font-semibold text-primary block mb-2">{{ __('landing.about_time_4_period') }}</span>
            <h4 class="font-display text-2xl text-dark uppercase mb-2">{{ __('landing.about_time_4_title') }}</h4>
