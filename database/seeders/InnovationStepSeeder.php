    ...
    public function run(): void
    {
        $steps = [
            ...
            [
                ...
                'description' => 'Every lot undergoes cupping, density sorting, and screen sizing. Only beans scoring 82+ points are approved for export. Vacuum-packed in food-grade GrainPro bags.',
                'description_id' => 'Setiap lot menjalani cupping, penyortiran densitas, dan sizing. Hanya biji dengan skor 82+ yang disetujui untuk ekspor. Dikemas vakum dalam kantong GrainPro food-grade.',
                'details' => 'SCA score: 82+, Screen: 16–18, GrainPro packed',
                'details_id' => 'Skor SCA: 82+, Screen: 16–18, Kemasan GrainPro',
                'order' => 6,
                'is_active' => true,
            ],
        ];
